    ...
    const card = React.useMemo(() => {
        ...
        const hostConfig = {
            ...
            "body": [
                ...
                {
                    "type": "TextBlock",
                    "text": "We just need for a few details.",
                    "wrap": true,
                    "size": "Small",
                    "color": "Dark"
                },
                ...
                },
                {
                    ...
                    "choices": [
                        {
                            "title": "Academy login/sign-up issue",
                            "value": "Academy login/sign-up issue"
                        },
                        {
                            "title": "Academy platform is not loading",
                            "value": "Academy platform is not loading"
                        },
                        {
                            "title": "Account merge request",
                            "value": "Account merge request"
                        },
                        {
                        ...
                        {
                            "title": "Diploma regeneration request",
                            "value": "Diploma regeneration request"
                        },
                        {
                        ...
                        {
                            "title": "Course content query",
                            "value": "Course content query"
                        },
                        {
                            "title": "Assignment question/clarification",
                            "value": "Assignment question/clarification"
                        },
                        {
                            "title": "Assignment validation issue",
                            "value": "Assignment validation issue"
                        },
                        {
                            "title": "Course progress was not saved",
                            "value": "Course progress was not saved"
                        },
                        {
                            "title": "Training materials could not be downloaded",
                            "value": "Training materials could not be downloaded"
                        },
                        {
                            "title": "Unable to download/view diploma",
                            "value": "Unable to download/view diploma"
                        },
                        {
                            "title": "Video do not load/buffer",
                            "value": "Video do not load/buffer"
                        },
                        {
                            "title": "Weblinks do not work",
                            "value": "Weblinks do not work"
                        },
                        {
